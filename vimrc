...
"Bundle 'shawncplus/phpcomplete.vim' " oh .....
"Bundle 'L9'
"Bundle 'AutoComplPop' " disable acp
Bundle 'Shougo/neocomplete.vim'
" try YCM, not so good for PHP
...
"Bundle 'garbas/vim-snipmate' " switch to neosnippet
...
let g:neocomplete#max_list = 20 " default is 100, that's too long
...
" cancel popup by <Space> and insert <Space>
...
let g:ycm_csharp_server_port = 4399
